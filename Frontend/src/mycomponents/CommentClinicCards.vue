...
import { ref } from "vue";
import TitleImage2 from "@/assets/images/bg/title2.jpg"
...
<template>
  <!-- ----------------------------------------------------------------------------- -->
  <!-- Comment Clinic -->
  <!-- 投稿を更新したら　当該技工装置に関連する歯科技工所と歯科技工士に通知する。 -->
  <!-- ----------------------------------------------------------------------------- -->
  ...
  <v-card elevation="2">
    <v-img
      ...
      cover
    >
      <v-card-title class="mt-2">歯科医療機関からの通知</v-card-title>
    ...
    <div class="text-subtitle-2 d-flex justify-end"> 投稿日：2022/1/23 </div>
      ...
      <v-card-subtitle class="no-ellipsis">※投稿内容は製作担当者と技工所のみ参照可能です。（患者参照不可）</v-card-subtitle>
    </div>
