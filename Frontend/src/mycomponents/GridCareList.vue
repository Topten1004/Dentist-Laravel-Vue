...
const patient_ticket_number = ref("");
const created_at = ref("");
const img = ref("/1.jpg");
const catchphrase = ref("");
const labonameRules = ref([(v: any) => !!v || "歯科医療機関の名称は必須項目です。"]);
...
const productfilter = ref([
  {
    ...
    patient_ticket_number: "123",
    created_at: "2022/1/9",
  },
  {
    img: "/2.jpg",
    clinic_name: "歯科医療機関名称２",
    patient_ticket_number: "1239",
    created_at: "2022/1/8",
  },
  {
    img: "/3.jpg",
    clinic_name: "歯科医療機関名称3",
    patient_ticket_number: "1923",
    created_at: "2022/1/7",
  },
  {
    img: "/4.jpg",
    clinic_name: "歯科医療機関名称4",
    patient_ticket_number: "1023",
    created_at: "2022/1/6",
  },
  {
    img: "/3.jpg",
    clinic_name: "歯科医療機関名称5",
    patient_ticket_number: "10023",
    created_at: "2022/1/6",
  },
  {
    img: "/2.jpg",
    clinic_name: "歯科医療機関名称6",
    patient_ticket_number: "000123",
    created_at: "2022/1/5",
  },
  {
    img: "/1.jpg",
    clinic_name: "歯科医療機関名称7",
    patient_ticket_number: "aaa123",
    created_at: "2022/1/4",
  },
  {
    img: "/2.jpg",
    clinic_name: "歯科医療機関名称8",
    patient_ticket_number: "ccc123",
    created_at: "2022/1/3",
  },
  {
    img: "/3.jpg",
...
function addProduct() {
  ...
  if (form.value.validate(true)) {
    const product = {
      ...
      patient_ticket_number: patient_ticket_number.value,
      created_at: created_at.value,
      img: img.value,
    };
    productfilter.value.unshift(product);
    clinic_name.value = "";
    patient_ticket_number.value = "";
    created_at.value = "";
    img.value = "";
  }
}
  ...
  <v-card class="mb-7">
    <v-card-text class="pa-5">
      <v-row justify="space-between">
        ...
        <!-- 【注意】 
          医療機関ログインしている場合
          当該医療機関のスタッフが担当した患者データのみ表示する
          その際、医療機関名で検索するのではなく、診察券番号で検索する
         -->
          <!-- <v-text-field
            v-model="search"
            prepend-inner-icon="mdi-magnify"
    ...
    <div class="ma-2">
      <p class="ml-2">
        ...
        CS24→ ソースコードにある【注意】事項を必ず参照してください。
      </p>
    </div>
  </v-card>
    ...
    >
      <v-card>
        ...
        <v-card-text class="pa-5 text-center">
          ...
          <h5 class="title h5">診察券：{{ productgrid.patient_ticket_number }}</h5>
