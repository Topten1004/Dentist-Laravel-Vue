...
import { ref } from "vue";
import TitleImage3 from "@/assets/images/bg/title3.jpg"
...
<template>
  <!-- ----------------------------------------------------------------------------- -->
  <!-- Comment Higienist -->
  <!-- 投稿更新したら　当該技工装置に関連する歯科技工所と歯科技工士に通知する。 -->
  <!-- ----------------------------------------------------------------------------- -->
  ...
  <v-card elevation="2">
    <v-img
      ...
      cover
    >
      <v-card-title class="mt-2">歯科衛生士からのコメント</v-card-title>
    ...
    <div class="text-subtitle-2 d-flex justify-end"> 投稿日：2022/1/23 </div>
      ...
      <div class="mt-4">
        （<!-- {{ higenist.name }} -->ここに(歯科衛生士名）＊＊＊＊歯科衛生士さんが投稿したコメントを記載します。
      </div>
