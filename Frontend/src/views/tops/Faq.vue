<template>
  <v-sheet color="transparent">
    <v-container class="py-4 py-lg-10 mt-14">
      <div class="text-center">
        <div class="text-overline mb-3">Support</div>
        <h2 class="text-h3 text-lg-h2">Frequently Asked Questions</h2>
        <v-responsive max-width="1200" class="mx-auto">
          <div class="text-h6 text-lg-h5 mt-4 mb-12">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus impedit error labore doloremque fugit! Dolor fugit molestiae vero quos quisquam nobis, eos debitis magni omnis ea incidunt amet voluptate dignissimos!</div>
        </v-responsive>
      </div>
      <v-row class="mt-6">
        <v-col
