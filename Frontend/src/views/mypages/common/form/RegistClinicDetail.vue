...
import IndexClinic from "@/views/mypages/clinic/IndexClinic.vue";
...
const submitFunction = () => {
  IndexClinic.post('/Inertia',form)
}

const form = reactive({
clinic_name: null,
clinic_phonetic: null,
clinic_phonetic_spelling: null,
clinic_owner_name: null,
zip_code: null,
clinic_address1: null,
clinic_address2: null,
email: null,
    ...
    <v-card-text class="pa-3">
      <v-row class="mt-1">
        <v-col cols="12" lg="6">
          ...
          <v-col cols="12" lg="6">
          <v-text-field
            v-model="form.clinic_phonetic_spelling"
            label="よみがな英語表記:"
            variant="outlined">
          </v-text-field>
          </v-col>
          <v-col cols="12" lg="6">
          <v-text-field
            v-model="form.clinic_owner_name"
            label="代表者名:"
            variant="outlined">
          </v-text-field>
          </v-col>
          ...
          <v-col cols="12">
          <v-text-field
            v-model="form.clinic_address1"
            label="住所1:"
            variant="outlined">
          </v-text-field>
          <v-text-field
            v-model="form.clinic_address2"
            label="住所2:"
            variant="outlined">
          </v-text-field>
          </v-col>
          ...
          <!-- 注意：
              v-model="form.speciality_clinic"
              以下専門分野は、form.speciality_clinic　に梱包される内容
           -->
          ...
          <v-col cols="12">
          <span class="text-10">歯科医院の概略を記載してください。</span>
          <v-textarea
