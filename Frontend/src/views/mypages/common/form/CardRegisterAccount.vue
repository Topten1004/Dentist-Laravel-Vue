...
<template>
  ...
  <div class="mx-8 mb-8">
    <h6 class="text-subtitle-1 text-grey-darken-1">
      アカウント情報を登録・確認・更新してください。<br>
      アカウント登録の後、必ず次の「詳細・経歴登録」を行なってください。
    </h6>
    <v-row class="mt-3">
      <v-col cols="12">
        ...
        <v-text-field label="ニックネーム:nickname" variant="outlined"></v-text-field>
        <v-text-field label="携帯電話番号:phone_no" variant="outlined"></v-text-field>
        <v-text-field label="Email:email" variant="outlined"></v-text-field>
        <div class="text-caption mb-1">※住所情報は就業先と所属学会における所属照合に活用します。</div>
        <v-text-field label="ご住所※:address" variant="outlined"></v-text-field>
