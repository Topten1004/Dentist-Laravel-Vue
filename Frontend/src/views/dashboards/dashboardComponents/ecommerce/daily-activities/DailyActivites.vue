...
<template>
  <v-card>
    <v-card-text>
      ...
      <img
        src="@/assets/images/background/blog-bg-2x.jpg"
        alt="image"
        style="width: 100%"
      />

      <h4 class="title font-weight-medium text-h6 mt-6">
        React 18 coming soon!
      </h4>
      <h5 class="text-subtitle-2 text-grey-darken-1">By Johnathan Doe</h5>
